  ...
  <motion.div variants={timelineItemVariants} className="mb-12 flex items-start -ml-2">
    ...
    <div className="flex-grow pl-10 md:pl-12">
      <div className="bg-[#1D042F] p-6 rounded-xl shadow-lg border border-purple-700 flex items-start space-x-6">
        {logo && <img src={logo} alt={institution} className="w-20 h-20 object-contain rounded-sm bg-white p-2 flex-shrink-0" />}
        <div>
          <h4 className="text-xl md:text-2xl font-semibold mb-1">{institution}</h4>
          <p className="text-lg text-gray-300 mb-1">{degree}</p>
